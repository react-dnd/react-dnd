...
const BoxWithHandleRaw = ({ isDragging, connectDragSource, connectDragPreview, connectDropTarget, }) => {
    const opacity = isDragging ? 0.4 : 1;
    return connectDropTarget(connectDragPreview(<div style={{ ...style, opacity }}>
