...
class FrameBindingContext extends React.Component {
    render() {
        return (<FrameContextConsumer>
				{({ window }) => (<DragDropContextProvider backend={HTML5Backend} context={window} debugMode={isDebugMode()}>
						{this.props.children}
...
export default class Container extends React.Component {
    render() {
        ...
        return (<Frame style={{ width: '100%', height: 400 }}>
				<FrameBindingContext>
					<div>
