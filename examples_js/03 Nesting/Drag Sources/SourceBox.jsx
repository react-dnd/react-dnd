...
const SourceBox = DragSource((props) => props.color + '', ColorSource, (connect, monitor) => ({
...
export default class StatefulSourceBox extends React.Component {
    ...
    render() {
        return (<SourceBox {...this.props} forbidDrag={this.state.forbidDrag} onToggleForbidDrag={() => this.handleToggleForbidDrag()}/>);
    }
